...
public class SessionManager implements ConfigDefs {
	 ...
	 */
	public Session createSession(Event anEvent) throws PushletException, UnsupportedEncodingException {
		// Trivial
		if(null != anEvent.getField("userId") && !"".equalsIgnoreCase(anEvent.getField("userId"))){
	...
	public int getSessionCount() {
		synchronized (mutex) {
			return sessions.entrySet().size()-1;
		}
	}
